...
const teamsData = [
  {
    ...
    schedule: "Rehearsals: Thursdays 6-8pm, Sundays 8-10am",
  },
  {
    id: "instrumentalists",
  ...
  },
  {
    ...
    category: "Outreach",
    icon: <HeartHandshake />,
    leader: "Samuel Kariuki",
    phone: "+254 777 666 777",
  ...
  },
  {
    ...
    category: "Service",
    icon: <HeartHandshake />,
    leader: "Sister Jane Akinyi",
    phone: "+254 799 654 321",

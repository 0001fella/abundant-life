          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {filteredEvents.length === 0 ? (
              ...
              filteredEvents.map((event, index) => (
                <motion.div
                  key={event._id}
                  className="rounded-2xl overflow-hidden shadow-xl border border-emerald-500/20 bg-[#0c1b33] transition-all duration-300 hover:border-emerald-500/50 hover:shadow-2xl"
